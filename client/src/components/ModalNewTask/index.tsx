...
type Props = {
  ...
  id?: string | null;
  projectId?: number;
  onProjectIdChange?: (newProjectId: number) => void;
};
...
const ModalNewTask = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const resolvedProjectId = id !== null
        ? Number(id)
        : projectId !== undefined
          ? projectId
          : 0;
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (value && onProjectIdChange) {
                  onProjectIdChange(Number(value));
                }
              }}
              required={id === null}
              min="1"
